package com.hdb.user.client.common;
...
public class ClientAuthenticationFilter extends AuthenticationFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if(StringUtils.isEmpty(backUrl)){
            backUrl = this.domain + ((HttpServletRequest)request).getRequestURI();
    ...
    protected void saveRequest(ServletRequest request, String backUrl, String fallbackUrl) {
        ...
        session.setAttribute("authc.fallbackUrl", backUrl);
        SavedRequest savedRequest = new ClientSavedRequest(httpRequest, backUrl);
        //SavedRequest savedRequest = new ClientSavedRequest(httpRequest, fallbackUrl);
    ...
    private String getDefaultBackUrl(HttpServletRequest request) {
        ...
        //return "http://localhost/i/account/summary";
    }
